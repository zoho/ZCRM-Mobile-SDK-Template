...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    //var loginHandler : LoginActivity?
...
//        loginHandler = LoginActivity.init()
//        self.readConfiguration()
//        let appConfig = CRMAppConfigUtil(appConfigDict: appConfigurationDict )
//        appConfig.setAppType( type : "ZCRM" )
//        loginHandler = LoginActivity(appConfigUtil: appConfig )
//        let alreadyLaunched = UserDefaults.standard.bool(forKey:"first")
//        if !alreadyLaunched {
//            loginHandler!.clearZCRMLoginFirstLaunch()
//            UserDefaults.standard.set(true, forKey: "first")
//        }
//        loginHandler!.initZCRMLogin( window : self.window )
        return true
    }
    
    func application(_ application: UIApplication, open url: URL, sourceApplication: String?, annotation: Any) -> Bool {
       // loginHandler?.zCRMLoginHandleURL(url: url, sourceApplication: sourceApplication, annotation: annotation)
        return true
    }
